...
if (isset($_GET['id'])) {
  ...
  $beneficiary_query = "SELECT * FROM archives WHERE id = $id";
  ...
  if (isset($_POST['action'])) {
      ...
      switch ($action) {
          case 'MODIFIER':
              ...
              if (isset($_GET['id'])) {
                  $id = $_GET['id'];
                  echo "<script>window.location.href='modifier_ar?id=$id';</script>";
              } else {
              ...
              <div class="accordion-item">
                ...
                <div id="collapse_n" class="accordion-collapse collapse" aria-labelledby="heading_n" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    ...
                    <div class="row mt-12">
                      <div class="col-md-12"><label class="labels">paramètres<br></label>
                      <div class="row mb-3">
                        <div class="col-sm-8">
                          <form method="POST">
...
function downloadBeneficiary(id) {
  ...
  window.location.href = 'download_ar?id=' + id;
}
